                ...
                >
                    <div className='md:space-x-10 md:space-y-4'>
                        ...
                        <h1 className='capitalize  mb-5 text-slate-300 text-justify text-sm'>
                            I design and code beautifully simple things,and engineer seamless web
                            solutions, merging form and function. Passionate about crafting digital
                            experiences and I love what I do.
                        </h1>
