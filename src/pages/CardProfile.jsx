...
function Card() {
  ...
  return (
    <div className='relative w-full lg:h-screen h-screen md:pt-36 pt-36' id='profile'>
      <p className='text-2xl text-rose-600 md:text-4xl font-bold text-center pb-4 md:pb-20'>
        Profile
      </p>
      <div
