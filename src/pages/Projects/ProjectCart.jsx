...
const ProjectCart = (props) => {
    ...
    return (
        <div className={`md:flex md:flex-row${isOdd(index) && "-reverse"} md:items-center md:pt-10 pt-24`}>
            <motion.div
                ...
                <div className='md:flex md:flex-col items-center text-center md:gap-6 pb-4 md:pb-0'>
                    <p
                        className={` ${
                            dark ? "text-[#27c7b7] before:bg-[#68fff1]" : "text-rose-600 before:bg-rouse-600"
                        }  uppercase lg:text-4xl md:text-3xl text-2xl relative before:absolute before:rounded-lg before:w-14 before:h-[3px]  before:-bottom-1`}>
                        {name}
                    </p>
                    <div
                        className={`${
            ...
            <motion.div
                ...
                <a href={url}>
                    <img src={img} alt='' className='rounded-full hover:rounded-3xl transition-all duration-500' />
                </a>
